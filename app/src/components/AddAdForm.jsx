...
export default function AddAdForm({ onAdAdded }) {
  ...
  return (
    <div className="bg-white border border-stone-200 rounded-sm p-6">
      <h2 className="font-serif text-lg text-stone-900 mb-4">Add New Ads from X.com</h2>
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            placeholder="Paste URLs here (auto-adds on paste) or type and press Enter"
          ...
          <p className="text-xs text-stone-400 mt-1">
            {batchUrls.length > 0
              ...
              : 'Paste multiple URLs at once or add one at a time'
            }
          </p>
        </div>
